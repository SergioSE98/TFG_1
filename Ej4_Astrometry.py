...
seaborn.distplot(dif_ra_2mass,bins=60, label= "RA diferences between matched point sources", hist_kws=dict(edgecolor="k", linewidth=0.3))
seaborn.distplot(dif_dec_2mass,bins=60, label= "DEC diferences between matched point sources", hist_kws=dict(edgecolor="k", linewidth=0.3))
seaborn.distplot(gamma_2mass,bins=40, label= "Angular distance between matched point sources", hist_kws=dict(edgecolor="k", linewidth=0.3)) 
plt.legend()
...
seaborn.distplot(dif_ra_gaia,bins=60, label= "RA diferences between matched point sources", hist_kws=dict(edgecolor="k", linewidth=0.3))
seaborn.distplot(dif_dec_gaia,bins=60, label= "DEC diferences between matched point sources", hist_kws=dict(edgecolor="k", linewidth=0.3))
seaborn.distplot(gamma_gaia,bins=40, label= "Angular distance between matched point sources", hist_kws=dict(edgecolor="k", linewidth=0.3)) 
plt.legend()
plt.xlabel("Seconds of arc")
plt.tight_layout()
plt.show()
...
seaborn.distplot(gamma_2mass,bins=40, label= "Angular distance between matched point sources for SHARKS-2MASS", hist_kws=dict(edgecolor="k", linewidth=0.3)) 
seaborn.distplot(gamma_gaia,bins=40, label= "Angular distance between matched point sources for SHARKS-GAIA", hist_kws=dict(edgecolor="k", linewidth=0.3)) 
plt.legend()
plt.xlabel("Seconds of arc")
plt.tight_layout()
plt.show()
