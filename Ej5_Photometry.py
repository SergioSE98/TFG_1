...
CLASSSTAT = dat1["CLASSSTAT"]  #Meto esto para filtrar solo estrellas

dec2 = dat2["DEJ2000"]
ra2 = dat2["RAJ2000"]
mag2 = dat2["Ksap3"]   #Kspmag es petrosian magnitude. También: Ksap3, Ksap4, Ksap6 (fuentes puntuales) y Ksapc3, Ksapc4, Ksap6...
err_mag2 = dat2["e_Ksap3"]
...
CLASS_SHARKS = CLASSSTAT[matches_viking["i1"]]
