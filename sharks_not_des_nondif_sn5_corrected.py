# -*- coding: utf-8 -*-
"""
Created on Sun Apr  4 13:56:23 2021
...
dat1=Table.read("fits/sharks_only_not_des_nodifrac_sig_noise_5_lite_corrected.fits", format="fits")      
...
i2 = plt.figure("(RA,DEC) of objects in SHARKS and not in DES (s/n = 5)")
...
plt.title("Petromag histogram of objects in SHARKS and not in DES (s/n = 5)")
...
plt.title("Petromag - Petromagerr of objects in SHARKS and not in DES (s/n = 5)")
