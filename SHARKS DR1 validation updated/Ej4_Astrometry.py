...
print("El valor medio de delta RA para SHARKS-2MASS es: %f" %np.mean(dif_ra_2mass))
print("La desviación estándar de delta RA para SHARKS-2MASS es: %f"  %np.std(dif_ra_2mass))

print("El valor medio de delta Dec para SHARKS-2MASS es: %f" %np.mean(dif_dec_2mass))
print("La desviación estándar de delta Dec para SHARKS-2MASS es: %f"  %np.std(dif_dec_2mass))

image1 = plt.figure("Astrometry for SHARKS-2MASS")
#plt.title("Astrometry for SHARKS-2MASS")
seaborn.distplot(dif_ra_2mass,bins=40, kde = False, label= r"RA diferences $\delta_{RA}$ between matched light sources", hist_kws=dict(edgecolor="k", linewidth=1))
seaborn.distplot(dif_dec_2mass,bins=40, kde = False, label= r"Dec diferences $\delta_{Dec}$ between matched light sources", hist_kws=dict(edgecolor="k", linewidth=1))
seaborn.distplot(gamma_2mass,bins=20, kde = False, label= r"Angular distance $\gamma$ between matched light sources", hist_kws=dict(edgecolor="k", linewidth=1)) 
plt.legend()
...
print("El valor medio de delta RA para SHARKS-GAIA es: %f" %np.mean(dif_ra_gaia))
print("La desviación estándar de delta RA para SHARKS-GAIA es: %f" %np.std(dif_ra_gaia))

print("El valor medio de delta Dec para SHARKS-GAIA es: %f" %np.mean(dif_dec_gaia))
print("La desviación estándar de delta Dec para SHARKS-GAIA es: %f" %np.std(dif_dec_gaia))

image2 = plt.figure("Astrometry for SHARKS-GAIA")
#plt.title("Astrometry for SHARKS-GAIA")
seaborn.distplot(dif_ra_gaia,bins=40, kde = False, label= r"RA diferences $\delta_{RA}$ between matched light sources", hist_kws=dict(edgecolor="k", linewidth=1))
seaborn.distplot(dif_dec_gaia,bins=40, kde = False, label= r"Dec diferences $\delta_{Dec}$ between matched light sources", hist_kws=dict(edgecolor="k", linewidth=1))
seaborn.distplot(gamma_gaia,bins=20, kde = False, label= r"Angular distance $\gamma$ between matched light sources", hist_kws=dict(edgecolor="k", linewidth=1)) 
plt.legend()
plt.xlabel("arcseconds")
plt.ylabel("Number of objects")
plt.ylim(0,5000)
...
seaborn.distplot(gamma_2mass,bins=40,kde = False, label= r"SHARKS-2MASS angular distance $\gamma$ between matched light sources", hist_kws=dict(edgecolor="k", linewidth=1)) 
seaborn.distplot(gamma_gaia,bins=40, kde = False, label= r"SHARKS-Gaia angular distance $\gamma$ between matched light sources ", hist_kws=dict(edgecolor="k", linewidth=1)) 
plt.legend()
plt.xlabel("arcseconds")
plt.ylabel("Number of objects")
plt.ylim(0,2500)
...
image1.savefig('ej4_Astrometry_SHARKS_2MASS.png')
image2.savefig('ej4_Astrometry_SHARKS_GAIA.png')   
image3.savefig("ej4_Astrometry_SHARKS_2MASS_and_SHARKS_GAIA.png")