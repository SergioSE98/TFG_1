...
plt.subplot(421)
#plt.xlim(4,10)
plt.hist(r_Ks_10,bins = 60)
plt.subplot(422)
#plt.xlim(4,10)
plt.hist(r_Ks_11,bins = 60)
plt.subplot(423)
#plt.xlim(4,10)
plt.hist(r_Ks_12,bins = 60)
plt.subplot(424)
#plt.xlim(4,10)
plt.hist(r_Ks_13,bins = 60)
plt.subplot(425)
#plt.xlim(4,10)
plt.hist(r_Ks_14,bins = 60)
plt.subplot(426)
#plt.xlim(4,10)
plt.hist(r_Ks_15,bins = 60)
plt.subplot(427)
#plt.xlim(4,10)
plt.hist(r_Ks_16,bins = 60)
plt.subplot(428)
#♦plt.xlim(4,10)
plt.hist(r_Ks_17,bins = 60)
plt.show()
...
print(r_Ks_medios)
num_galax = [len(df_galaxies_10), len(df_galaxies_11), len(df_galaxies_12), len(df_galaxies_13), len(df_galaxies_14), len(df_galaxies_15), len(df_galaxies_16), len(df_galaxies_17)]
print(num_galax)