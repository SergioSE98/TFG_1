# -*- coding: utf-8 -*-
"""
Created on Sun Apr  4 12:42:30 2021
...
dat1=Table.read("fits/sharks_and_des_sig_noise_3_EROS_not_R_lite.fits", format="fits")  #EROS, objetos con R-Ks mayor a 5.5
...
i1 = plt.figure("Magnitudes Sharks and DES objects (not R detection) (s/n = 3)")
...
i1.savefig('Mag_R-Mag_K_R_not_detect.png')   